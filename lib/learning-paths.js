export const LEARNING_PATHS = [
  {
    ...
    stations: ['einstieg-1', 'einstieg-2', 'einstieg-3', 'verwaltung-1', 'claude-1', 'context-1', 'usecase-lab', 'usecase-6', 'next-4']
  },
  {
    id: 'praxis',
    title: 'Praxis',
    ...
    stations: ['verwaltung-2', 'claude-2', 'context-1', 'context-2', 'usecase-4', 'usecase-5', 'usecase-lab', 'usecase-6', 'usecase-7', 'skills-3', 'next-4']
  },
  {
    id: 'power-user',
    title: 'Power User',
    ...
    stations: ['claude-3', 'claude-4', 'usecase-7', 'skills-1', 'skills-2', 'skills-3', 'next-2', 'next-3', 'next-4']
  },
  {
    id: 'governance',
    ...
    stations: ['verwaltung-1', 'verwaltung-2', 'claude-5', 'context-1', 'usecase-1', 'usecase-6', 'usecase-7', 'next-1', 'next-3', 'next-4']
  }
];
...
export const TRAINER_VARIANTS = [
  {
    ...
    probeCues: [
      ...
      'Falls Zeit kippt: Mini-Fallbibliothek nur als Take-away zeigen'
    ]
  },
  {
    id: '120',
